...
namespace CapstoneQuizAPI.Migrations
{
    ...
    [Migration("20200812192723_TopicToSessionsCorrelation")]
    partial class TopicToSessionsCorrelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CapstoneQuizAPI.Models.Question", b =>
                {
                    b.HasOne("CapstoneQuizAPI.Models.Topic", null)
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("CapstoneQuizAPI.Models.SessionQuestion", b =>
                {
                    b.HasOne("CapstoneQuizAPI.Models.Question", "Question")
                        .WithMany()
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CapstoneQuizAPI.Models.ResultType", "ResultType")
                        .WithMany()
                        .HasForeignKey("ResultTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CapstoneQuizAPI.Models.TestSession", null)
